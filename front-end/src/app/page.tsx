...
export default function Home() {
  ...
  return (
    <>
      ...
      <section 
        className="bg-gray-50 py-12 sm:py-14 md:py-16 lg:py-20 xl:py-24 2xl:py-28 text-center" 
        ref={serviciosRef}
      >
      ...
      <section 
        className="bg-white py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 2xl:py-32 text-gray-800" 
        ref={nosotrosRef}
      >
      ...
      {/* Sección de Contacto */}
      <section 
        className={`min-h-screen bg-[#1a2f38] flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-12 text-white ${inter.className}`} 
        ref={contactoRef}
      >
  ...
  try {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/chat`, {
      ...
      headers: {
        ...
        "Sec-GPC": gpc, // ✅ acá mandamos el header nuevo
      },
      body: JSON.stringify({
